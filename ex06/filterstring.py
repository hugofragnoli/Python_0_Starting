...
def main():
    ...
    try:
        ...
        # Si len > n_min -> true
        check_len = lambda word: len(word) > n_min

        # List comprehension contrainte
        # .split() pour isoler les mots
        #s.arg.split(decoupe arg 1 en une liste de mots indiv)
        # for w in : -> boucle-> on prend chaque mot de la list et on le soumet a filter
        # chaque mot sappelle w temporairement.
        #ft_filter  parcourt chaque mot et demande a lambda si cest true ou false.
